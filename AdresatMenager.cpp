    ...
    for (int i = 0; i < adresaci.size(); i++)
    {
        if (adresaci[i].pobierzId() == idEdytowanegoAdresata)
        {
            ...
            case '2':
                ...
                adresaci[i].ustawNazwisko
                (MetodyPomocnicze::zamienPierwszaLitereNaDuzaAPozostaleNaMale(adresaci[i].pobierzNazwisko()));
                plikZAdresatami.edytujWybranegoAdresataWPliku(adresaci[i]);
                break;
            case '3':
...
void AdresatMenager::wyszukajAdresatowPoNazwisku()
{
    ...
    if (!adresaci.empty())
    {
        ...
        nazwiskoPoszukiwanegoAdresata =
        MetodyPomocnicze::zamienPierwszaLitereNaDuzaAPozostaleNaMale(nazwiskoPoszukiwanegoAdresata);
